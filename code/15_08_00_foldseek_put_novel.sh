...
#SBATCH --exclusive
#SBATCH -o 15_08_01_foldseek_put_novel.log-%j
#SBATCH -c 40
...
PDB1=../data3/interim/df_rep_structures/
DB1=../data3/interim/foldseek_dbs/df_rep_foldseek_db
PADDB1=../data3/interim/foldseek_dbs/df_rep_foldseek_db_pad
PDB2=../data3/interim/ecor_putative_novel_structures/
DB2=../data3/interim/foldseek_dbs/ecor_putative_novel_foldseek_db
PADDB2=../data3/interim/foldseek_dbs/ecor_putative_novel_foldseek_db_pad
RESDB=../data3/interim/foldseek_dbs/ecor_put_nov_df_rep_search
RESFILE=../data3/interim/ecor_put_nov_df_rep_search.txt
# Run the script
conda run -n nvcc /home/gridsan/pdeweirdt/Documents/foldseek/build/bin/foldseek \
    createdb $PDB1 $DB1

conda run -n nvcc /home/gridsan/pdeweirdt/Documents/foldseek/build/bin/foldseek \
    makepaddedseqdb $DB1 $PADDB1
