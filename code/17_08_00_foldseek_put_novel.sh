...
#SBATCH --exclusive
#SBATCH -o 17_08_01_foldseek_put_novel.log-%j
#SBATCH -c 40
...
PDB2=../data3/interim/refseq1k_put_novel_structures/
DB2=../data3/interim/foldseek_dbs/refseq1k_put_novel_foldseek_db
PADDB2=../data3/interim/foldseek_dbs/refseq1k_put_novel_foldseek_db_pad
RESDB=../data3/interim/foldseek_dbs/refseq1k_put_novel_df_rep_search
RESFILE=../data3/interim/refseq1k_put_novel_rep_search.txt
# Run the script
